...
\begin{proof}[Beweis des Satzes]
    ...
    \begin{proof}[Beweis des HS]
        ...
        \begin{align*}
            ...
            +\frac{1}{d}\left(\left(x_N+c\right)c\left(r^2+1\right)-cx_N\sqrt{r^2+1}\right)\\
            ...
            \frac{cr\sqrt{r^2+1}}{\left(1-\sqrt{r^2+1}\right)^2+r^2}\frac{(x_N+c)\sqrt{r^2+1}-x_N}{r}\\
            &=x_Qx_N+y_Q\frac{(x_N+c)\sqrt{r^2+1}-x_N}{r}\\
        \end{align*}
        \begin{align*}
            x_Q^2+y_Q^2&=x_Qx_N+y_Q\frac{(x_N+c)\sqrt{r^2+1}-x_N}{r}\\
            &=2x_Q\frac{x_N}{2}+2y_Q\frac{(x_N+c)\sqrt{r^2+1}-x_N}{2r}\\
            &=2x_Qx_S+2y_Qy_S
        \end{align*}
        Aus der Gleichung $x_Q^2+y_Q^2=2x_Qx_S+2y_Qy_S$ ergibt sich mit HS \ref{cor_hilfe} direkt die Behauptung.
    \end{proof}
